                    ...
                    <div className={styles.topRight}>
                        ...
                        {!isSmallScreen && (
                            <div className={styles.registrationTime}>
                                {format(
                                    ls.LS_USER_DETAIL_PAGE_REG_TIME,
                                    momentFormatter(userDetail.registrationTime, "lll"),
                                )}
                            </div>
                        )}
                    </div>
                ...
                <div className={styles.bottom}>
                    <Pivot>
                        {userDetail.information && (
                            <PivotItem
                                headerText={ls.LS_COMMON_USER_INFO_LABEL}
                                ariaLabel={ls.LS_COMMON_USER_INFO_LABEL}
                            >
                        ...
                        <PivotItem
                            headerText={ls.LS_USER_DETAIL_PAGE_ANALYSIS_TAB}
                            ariaLabel={ls.LS_USER_DETAIL_PAGE_ANALYSIS_TAB}
                        >
                            <div className={styles.tabContainer}>
